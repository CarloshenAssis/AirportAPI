...
public class AirportController {
    ...
    public ResponseEntity<Object> findByCityIgnoreCase(@PathVariable String cityName) { 
...
return ResponseEntity.ok (result);
        ...
        * Retorna os aeroportos próximos a coodenada enviada como parâmetro * da requisição GET.
        *
        *@param latitude
        *@param longitude
        * @return
